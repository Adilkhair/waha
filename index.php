...
<html lang="en">
	<head>
	    ...
	    <title>  أحفاد خاطر للانشطة المتعددة</title>
			...
			<div class="col-md-6 col-sm-4 col-lg-4">
				<div class="info-box">
					<div class="row">
						...
						<div class="col-xs-10">
							<h4 class="info-box-heading green">الضمان</h4>
						</div>
					</div>	
					<h6 class="text">ضمان لمدة 30 سوم.</h6>
				</div>
			</div><!-- .col -->
			...
			<div class="hidden-md col-sm-4 col-lg-4">
				<div class="info-box">
					<div class="row">
						...
						<div class="col-xs-10">
							<h4 class="info-box-heading orange">توصيل مجاني</h4>
						</div>
					</div>
					<h6 class="text">توصيل مجاني للطلبات الاكثر من 100000ج</h6>	
				</div>
			</div><!-- .col -->
			...
			<div class="col-md-6 col-sm-4 col-lg-4">
				<div class="info-box">
					<div class="row">
						...
						<div class="col-xs-10">
							<h4 class="info-box-heading red"> تخفيضات  </h4>
						</div>
					</div>
					<h6 class="text">كل المتجات - تخيضات حتي 20% </h6>	
				</div>
			</div><!-- .col -->
		</div><!-- /.row -->
...
<!-- ============================================== INFO BOXES : END ============================================== -->		
		...
		<div id="product-tabs-slider" class="scroll-tabs inner-bottom-vs  wow fadeInUp">
			<div class="more-info-tab clearfix">
			   <h3 class="new-product-title pull-left">منتجات مميزة</h3>
				<ul class="nav nav-tabs nav-tab-line pull-right" id="new-products-1">
					<li class="active"><a href="#all" data-toggle="tab">الكل</a></li>
					<li><a href="#" data-toggle="tab">أثاث دمياطي</a></li>
					<li><a href="#" data-toggle="tab">أثاث مستورد</a></li>
				</ul><!-- /.nav-tabs -->
			</div>
