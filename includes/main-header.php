	...
	?>
			...
			<div class="clearfix cart-total">
				<div class="pull-right">
						...
						<span class="text">الاجمالي :</span><span class='price'>Rs.<?php echo $_SESSION['tp']="$totalprice". ".00"; ?></span>
						
				</div>
			
				<div class="clearfix"></div>
					
				<a href="my-cart.php" class="btn btn-upper btn-primary btn-block m-t-20">عربة التسوق</a>	
			</div><!-- /.cart-total-->
...
<div class="dropdown dropdown-cart">
		<a href="#" class="dropdown-toggle lnk-cart" data-toggle="dropdown">
			<div class="items-cart-inner">
				<div class="total-price-basket">
					<span class="lbl">عربة التسوق -</span>
					<span class="total-price">
		...
		<ul class="dropdown-menu">
			...
			<div class="clearfix cart-total">
				...
				<a href="index.php" class="btn btn-upper btn-primary btn-block m-t-20">متابعة التسوق</a>	
			</div><!-- /.cart-total-->
...
<div class="search-area">
    <form name="search" method="post" action="search-result.php">
        <div class="control-group">
            ...
            <input class="search-field" placeholder="أبحث هنا.." name="product" required="required" />
...
<div class="logo">
	<a href="index.php">
		...
		<h2>  أحفاد خاطر للانشطة المتعددة</h2>
