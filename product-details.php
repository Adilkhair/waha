...
<div class="sidebar-widget outer-bottom-xs wow fadeInUp">
	<h3 class="section-title">التصنيات</h3>
...
<div class="sidebar-widget hot-deals wow fadeInUp">
	<h3 class="section-title">إتفاق</h3>
					...
					<div class="products">
						...
						<div class="product-info text-left m-t-20">
							...
							<div class="product-price">	
								<span class="price">
									ج س. <?php echo htmlentities($rws['productPrice']);?>.00
								</span>
									
							    <span class="price-before-discount">ج س.<?php echo htmlentities($row['productPriceBeforeDiscount']);?></span>					
						...
						<div class="cart clearfix animate-effect">
							...
							<button class="btn btn-primary" type="button">إضافة إلي السلة</button></a>
								<?php } else {?>
							<div class="action" style="color:red">غير موجودة في المخذن حاليا</div>
					<?php } ?>
...
?>		
							<div class="rating-reviews m-t-20">
								<div class="row">
									...
									<div class="col-sm-8">
										<div class="reviews">
											<a href="#" class="lnk">(<?php echo htmlentities($num);?> التقيمات)</a>
										</div>
									</div>
								</div><!-- /.row -->		
							</div><!-- /.rating-reviews -->
...
<div class="stock-container info-container m-t-10">
								<div class="row">
									<div class="col-sm-3">
										<div class="stock-box">
											<span class="label">علامة المنتج :</span>
										</div>	
									</div>
									<div class="col-sm-9">
										<div class="stock-box">
...
<div class="stock-container info-container m-t-10">
								<div class="row">
									<div class="col-sm-3">
										<div class="stock-box">
											<span class="label">تكالية التوصيل :</span>
										</div>	
									</div>
									<div class="col-sm-9">
										<div class="stock-box">
							...
							<div class="price-container info-container m-t-20">
								<div class="row">
									...
									<div class="col-sm-6">
										<div class="price-box">
											<span class="price">ج س. <?php echo htmlentities($row['productPrice']);?></span>
											<span class="price-strike">ج س.<?php echo htmlentities($row['productPriceBeforeDiscount']);?></span>
										</div>
									</div>
...
<?php if($row['productAvailability']=='In Stock'){?>
										<a href="product-details.php?page=product&action=add&id=<?php echo $row['id']; ?>" class="btn btn-primary"><i class="fa fa-shopping-cart inner-right-vs"></i> ADD TO CART</a>
													<?php } else {?>
							<div class="action" style="color:red">غير متوفر</div>
					<?php } ?>
									</div>
							...
							<div class="product-social-link m-t-20 text-right">
								<span class="social-label">نشر :</span>
					...
					<div class="row">
						<div class="col-sm-3">
							<ul id="product-tabs" class="nav nav-tabs nav-tab-cell">
								<li class="active"><a data-toggle="tab" href="#description">الوصف</a></li>
								<li><a data-toggle="tab" href="#review">التقييم</a></li>
								...
								<div id="review" class="tab-pane">
									<div class="product-tab">
										...
										<div class="product-reviews">
											<h4 class="title">تقييم الزبائنs</h4>
...
while($rw=mysqli_fetch_array($qry))
{
	...
	<div class="product">		
		...
		<div class="product-info text-left">
			...
			<div class="product-price">	
				<span class="price">
					ج .س.<?php echo htmlentities($rw['productPrice']);?>			</span>
										     <span class="price-before-discount">ج س.
				...
				<div class="action">
					<ul class="list-unstyled">
						...
						<a href="product-details.php?page=product&action=add&id=<?php echo $rw['id']; ?>" class="lnk btn btn-primary">أضف الي السلة</a>
